...
# General
This repository contains the source code accompanying the paper [Modelling local and general quantum mechanical properties with attention-based pooling](https://www.nature.com/articles/s42004-023-01045-7). It can be used to run all the experiments presented in the paper. It also includes all the random seeds and settings required for reproducibility.
